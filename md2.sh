...
while true; do
    ...
    if [[ $lite == "on" ]]; then
        ...
        cd ~/multidd/targets/; split -n 4 --additional-suffix=.uaripper ~/multidd/targets/uniq_targets.txt; cd ~/multidd/mhddos_proxy #split targets in N parts
